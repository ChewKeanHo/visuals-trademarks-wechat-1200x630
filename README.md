# Tencent's WeChat (WeChat) Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The WeChat Trademarks Logo. They published clear trademark guideline and
...
This project re-draws WeChat Trademarks Logo specifically for 1200x630 size.
...
Since WeChat published its brand and trademark guideline, **you MUST go through
all the following to avoid any unwanted legal implications**:

* https://newsroom.wechat.com/newsRooms/BrandingGuidelines

While not specified by WeChat, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Tencent's WeChat Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-wechat-1200x630
UUID: 3B1F1105-BF15-437E-94A3-2FF239D8A352
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-25
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-wechat-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH TENCENT'S WECHAT TRADEMARK REQUIREMENTS
> (Refer: https://newsroom.wechat.com/newsRooms/BrandingGuidelines)**.
>
